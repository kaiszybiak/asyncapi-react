...
const ServerSecurityItem: React.FunctionComponent<ServerSecurityItemProps> = ({
  ...
  if (protocol === 'kafka' || protocol === 'kafka-secure') {
    ...
    renderedKafkaSecurity = (
      <div className="aui-px-4 aui-py-2 aui-ml-2 aui-mb-2 aui-border aui-border-gray-400 aui-bg-gray-100 aui-rounded">
        {securityProtocol && (
          <div className="aui-mt-1">
            <span className="aui-text-xs aui-font-bold aui-text-gray-600 aui-mt-1 aui-mr-1 aui-uppercase">
              security.protocol:
            </span>
            <span className="aui-inline-block aui-font-bold aui-no-underline aui-bg-indigo-400 aui-text-white aui-text-xs aui-rounded aui-py-0 aui-px-1 aui-ml-1">
              {securityProtocol}
            </span>
          </div>
        )}
